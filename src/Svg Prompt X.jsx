const SvgPromptX = ({ style = {}, width, color = 'white', viewBox = '0 0 100 100' }) => {
  return (
    <svg id="svg-prompt-x" style={{ ...style, display: 'block' }} width={width} height={width} viewBox={viewBox} xmlns="http://www.w3.org/2000/svg">
      <g>
